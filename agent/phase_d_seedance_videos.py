...
DEFAULT_REPLICATE_PREDICTIONS = OUTPUT_DIR / "replicate_qwen_image_distilled_test_1109_50" / "replicate_predictions.jsonl"
...
def run(args: argparse.Namespace) -> list[dict[str, Any]]:
    ...
    first_frame_urls = load_first_frame_urls(args.replicate_predictions_jsonl)
        ...
        if args.execute:
            ...
            if args.wait and task_record["task_id"]:
                ...
                while True:
                    ...
                    content = poll_response.get("content")
                    if isinstance(content, dict) and content.get("video_url"):
                        task_record["video_url"] = content["video_url"]
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--replicate-predictions-jsonl", type=Path, default=DEFAULT_REPLICATE_PREDICTIONS)
